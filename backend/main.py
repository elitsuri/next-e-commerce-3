...
app = FastAPI(
    ...
    description="Next E-Commerce: Next.js storefront with SSR, product pages, cart, and payments",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "next-e-commerce"}
